...
insert into dmt.matter (node_id, name) values(1001, 'MATTER1001');
insert into dmt.matter (node_id, name) values(1002, 'MATTER1002');
insert into dmt.device (device_id, name, status, location) values(1001, 'Bulb1001', 'OFF', 'Main Bedroom');
insert into dmt.device (device_id, name, status, location) values(1002, 'Bulb1002', 'OFF', 'Boy Bedroom');
insert into dmt.device (device_id, name, status, location) values(1003, 'Bulb1003', 'OFF', 'Front Door');
insert into dmt.device (device_id, name, status, location) values(1004, 'Bulb1004', 'OFF', 'Garage');
insert into dmt.device (device_id, name, status, location) values(1005, 'Bulb1005', 'OFF', 'Basement');
insert into dmt.device (device_id, name, status, location) values(1006, 'Bulb1006', 'OFF', 'Girl Bedroom');
...
BEGIN
	...
	SET @new_device_id3 := (select max(device_id) + 3 from dmt.device);
  	insert into dmt.matter (node_id, name) values(@new_matter_node_id, concat('MATTER', @new_matter_node_id));
	insert into dmt.device (device_id, name, status, location) values(@new_device_id1, concat('Bulb', @new_device_id1), 'OFF', 'Not Defined');
	insert into dmt.device (device_id, name, status, location) values(@new_device_id2, concat('Bulb', @new_device_id2), 'OFF', 'Not Defined');
	insert into dmt.device (device_id, name, status, location) values(@new_device_id3, concat('Bulb', @new_device_id3), 'OFF', 'Not Defined');
